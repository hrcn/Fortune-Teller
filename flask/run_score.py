...
def score(input_img):
    ...
    def calculate_score(kpts):
        ...
        nose_score = abs((nosew/faceWidth)-25) + abs((noseH/faceWidth)-50)/8
        ...
        face_score = -face_score + 100

        if face_score < 0:
            face_score = math.log(-face_score, 1.1) 

        face_score = math.log(face_score, 1.1) + 50
    ...
    out = cd(hm)
    face_score = calculate_score(out)
